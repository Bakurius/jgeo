import { DollarSign, Users, TrendingUp, Award, CheckCircle2 } from "lucide-react";
...
const Affiliate = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    toast.success("თქვენი განაცხადი წარმატებით გაიგზავნა! ჩვენ მალე დაგიკავშირდებით.");
  ...
  const benefits = [
    ...
    },
    {
      icon: Users,
      title: "გუნდის შენება",
      description: "შექმენით თქვენი ქსელი და მიიღეთ შემოსავალი გუნდის გაყიდვებიდან"
    },
    {
      icon: TrendingUp,
      title: "უზრუნველყოფილი ზრდა",
      description: "სრული ტრენინგი და მარკეტინგული მხარდაჭერა თქვენი წარმატებისთვის"
    },
    {
      icon: Award,
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-16 px-4 bg-[var(--gradient-card)]">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            ...
            <span className="bg-[var(--gradient-health)] bg-clip-text text-transparent">ჯანმრთელობისადმი შემოსავლად</span>
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            შემოუერთდი JIFU-ს აფილიაციის პროგრამას და იმუშავე გუნდთან ერთად, რომელიც აცვლის ადამიანების ცხოვრებას
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">რატომ JIFU აფილიაცია?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, index) => {
              const IconComponent = benefit.icon;
              return (
                <Card key={index} className="text-center hover:shadow-[var(--shadow-hover)] transition-all">
                  <CardHeader>
      ...
      <section className="py-20 px-4 bg-accent/30">
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-4">საკომისიოს სტრუქტურა</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <Card className="border-2 border-primary/40 bg-accent">
                <CardHeader className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">შუალედური დონე</p>
                </CardHeader>
                <CardContent>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">როგორ დავიწყოთ?</h2>
      ...
      <section className="py-20 px-4 bg-[var(--gradient-card)]">
        <div className="container mx-auto max-w-2xl">
          <h2 className="text-3xl font-bold text-center mb-4">გაწევრიანების ფორმა</h2>
          ...
          <Card>
            <CardContent className="p-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium mb-2">სახელი და გვარი *</label>
                  <Input
                    required
                    value={formData.name}
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">დამატებითი ინფორმაცია</label>
                  <Textarea
