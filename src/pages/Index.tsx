  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-20 pb-32 px-4 overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 pt-16 flex justify-center">
          <div className="max-w-3xl text-middle">
            <div className="bg-black/20 backdrop-blur-sm rounded-3xl p-6 inline-block mb-5">
              ...
              <p className="text-base sm:text-lg md:text-xl text-white/90 mb-6 sm:mb-8 leading-relaxed">
                შემოგვიერთდი გლობალურ საზოგადოებაში, რომელიც აძლევს ხალხს ძალას
                ჯანმრთელობის, ენერგიისა და ფინანსური თავისუფლების მისაღწევად
              </p>
            </div>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              პრემიუმ ხარისხის დანამატები თქვენი ჯანმრთელობისა და
              კეთილდღეობისთვის
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-accent/30">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">რატომ JGEO?</h2>
            <p className="text-xl text-muted-foreground">
              მიზეზები თუ რატომ უნდა აირჩიოთ ჩვენ
            </p>
          </div>
            ...
            <Card className="text-center">
              <CardContent className="pt-8 pb-6">
                ...
                <p className="text-muted-foreground">
                  მხოლოდ საუკეთესო ინგრედიენტები და სამეცნიერო მტკიცებულებებზე
                  დაფუძნებული ფორმულები
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 px-4 bg-background">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              რეალური შედეგები, რეალური ადამიანებისგან
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-[var(--gradient-card)]">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6">
            მზად ხართ დაიწყოთ თქვენი მოგზაურობა?
          </h2>
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            შემოგვიერთდით ათასობით ადამიანს, რომლებმაც უკვე გარდაქმნეს თავიანთი
            ჯანმრთელობა და შემოსავალი JGEO-ს დახმარებით
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/affiliate">
              <Button
